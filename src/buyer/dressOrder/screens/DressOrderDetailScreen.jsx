...
import DressOrderInfoItem from '../components/DressOrderDetail/DressOrderInfoItem';

import DeliveryPartnerSection from '../sections/dressOrderDetail/DeliveryPartnerSection';

import WeddingMermaidRegularPng from '../../../assets/images_png/wedding_mermaid_regular.png';

import * as colors from '../../../config/colors';

const DressOrderDetailScreen = ({item}) => {
    ...
    return (
        <View style={[styles.container, {paddingTop: insets.top}]}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContentContainer} style={styles.scrollContainer} >
                ...
                />
                <DressOrderInfoItem title="Delivery address" description={deliveryAddress} />
                <DressOrderInfoItem title="Pickup/return address:" description={pickUpAddress} />
                <DressOrderInfoItem title="Total day for rent" description={'2 days'} />
                <DressOrderInfoItem title="Security deposits" description={`$${depositePrice}`} />
                <DressOrderInfoItem title="Total rental price" description={`$${price + depositePrice}`} />
                <DressOrderInfoItem title="Total rental price" description={`$${price + depositePrice}`} />
...
export default DressOrderDetailScreen;
